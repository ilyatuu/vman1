...
<ul class="nav nav-tabs" role="tablist">
  ...
  <%
  	...
  	case "MoH":
  		...
  		out.print("<li role='presentation'><a href='#tab1' role='tab' data-toggle='tab'>MDH PLHIV</a></li>");
  		start_tab = "tab0";
  		break;
  	case "Project1":
...
$(document).ready(function(){
	...
	//ODK forms
	//var odk_forms = ['"V_CORE"','"WHOVA151_CORE"','"HIA4SD_CORE"', '"WHOVAV153TZV2_CORE"'];
	var odk_forms = ['"WHOVAV153TZV2_CORE"'];
	 ...
	 $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
		  ...
		  case "#tab1":
			  ...
			  columns2 = [
					...
					{name:'"ID10005_R"',shortname:'death_loc_level1'},
					{name:'"ID10005_R"',shortname:'death_loc_level2'}
			  ];
