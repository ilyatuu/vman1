			...
			<%
				if(forms !=null){
					for(int i=0;i<forms.length();i++){
						...
						out.print("<h5 class='panel-title center'><i class='fa fa-map-o' aria-hidden='true'></i>"+form.getString("display_name")+"</h5>");
						out.print("</div>");
						...
						out.print("<div class='panel panel-info'>");
							...
							out.print("</div>");
							out.print("<div class='panel-body'>");
									out.print("<div id='map_canvas'>map goes here</div>");
							out.print("</div>");	
						out.print("</div>");	//end map
						
						out.print("</div>");	// end col-sm-7
...
$(document).ready(function(){
	...
	function setFormSummaryData2(forms){
	 ...
	 function displayVARecord(row, formid){
		 ...
		 $("#summary-gps-acc").text( row[ schema.gps_accuracy.replace( /\"/g,'' ) ] );
