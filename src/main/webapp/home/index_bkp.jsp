...
<div class="page-header">
	<div class="row">
		...
		<div class="col-sm-8" style="padding-top:8px;">
			...
			<h6 style="margin:1px;">Release version 1.4 2021</h6>
		</div>
	</div>
</div>
</div>
  ...
  <%
  	...
  	if(forms != null){
  		for (int i=0;i<forms.length();i++){
  			...
  			out.print("<li role='presentation'><a href='#tab"+form.getInt("id")+"' role='tab' data-toggle='tab'>"+form.getString("name")+"</a></li>");
  		}	
  	}
...
<div id="tab-content" class="tab-content" style="padding:5px;">
			...
			<%
				if(forms !=null){
					for(int i=0;i<forms.length();i++){
						...
						out.print("<h5 class='panel-title center'><i class='fa fa-map-o' aria-hidden='true'></i>"+form.getString("name")+"</h5>");
						out.print("</div>");
						...
						out.print("<div class='panel-body'>");
							...
							out.print("<div class='row row-underline'>");
								...
								out.print("<div class='col-md-6 text-right'>"+form.getString("details")+"</div>");
							out.print("</div>");
						...
						out.print("<div class='panel panel-info'>");
						out.print("<div class='panel-heading'>");
						out.print("<h5 class='panel-title center'><i class='fa fa-map-o' aria-hidden='true'></i> Monthly Submission</h5>");
						out.print("</div>");
	...
	<div class="tab-pane fade in" id="tab4">
		<!-- page title -->
		<div class="page-title">
			<h5><i class="fa fa-bars"></i> PLHIV MDH <small>items</small></h5>
			<div class="btn-group">
				<a href="#" class="btn btn-link btn-lg btn-icon dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cogs"></i><span class="caret"></span></a>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="fa fa-refresh"></i>Refresh</a></li>
						...
						<div class="form-inline" role="form">
							<div class="form-group">
								...
								<select data-tags="true" id="searchBy4" name="searchBy4" class="format_select2_no_search">
									<option value='"ID10010_GROUP_ID10010"'>Interviewer Name</option>
									<option value='"_URI"'>VA UUID</option>
								</select>
								</div>
							</div>
...
$(document).ready(function(){
	...
	// ===== tab configuratons ======/
	 ...
	 function displayVARecord(row, schema){
		 //clear
	 ...
	 $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
		  ...
		  case "#tab4":
			  ...
			  //dataModel = getDataModel(tblName);
			  columns1 = [
				  { name:'"GROP_03_CNSNTD_DECEASED_CRVS_INFO_N_DCSED_IS_NEONATAL"',shortname:'neonatal'},
				  { name:'"GROP_03_CNSNTD_DECEASED_CRVS_INFO_N_DCSED_IS_CHILD"', shortname:'child'},
				  { name:'"GROP_03_CNSNTD_DECEASED_CRVS_INFO_N_DCSED_IS_ADULT"', shortname:'adult'}
			  ];
			  
			  columns2 = [
				  {name:'"ID10010_GROUP_ID10010"',shortname:'interviewer_name'},
				  {name:'"INTERVIEW_ID10005_R"',shortname:'death_loc_level1'},
				  {name:'"INTERVIEW_ID10005_D"',shortname:'death_loc_level2'}
			  ];
